...
namespace UnluCo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UnluCoDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ConnStr")));
            services.AddIdentity<User, IdentityRole>()
                .AddEntityFrameworkStores<UnluCoDbContext>()
